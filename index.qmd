...
# **shinylive**: downloads R/py + packages to client and runs shiny there {background-color="#22ca8e"}
...
1. Package should be listed in the code chunk.
...
## Do we need shiny servers or Posit Connect anymore? 
